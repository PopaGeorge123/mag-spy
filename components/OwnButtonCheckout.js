...
const OwnButtonCheckout = ({ priceId, mode = "subscription" }) => {
  ...
  return (
    <button
      className="flex items-center justify-center text-sm rounded-lg bg-green-500 text-white px-2 py-1"
...
export default OwnButtonCheckout;
